            ...
            @method('PUT')
             <div class="flex flex-wrap -mx-3 mb-6">
              <div class="w-full px-3">
                <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">Status Transaksi</label>
                <select name="status" class="block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
                    ...
                    <option value="PENDING" class="inline-flex items-center justify-center px-2 py-1 mr-2 text-xs font-bold leading-none text-red-100 bg-red-600 rounded-full"">PENDING</option>  
                    <option value="SUCCESS" class="text-green-500">SUCCESS</option>  
                    <option value="FAILED" class="text-red-500">FAILED</option>  
                </select>
              </div>
            </div>
            <div class="flex flex-wrap -mx-3 mb-6">
